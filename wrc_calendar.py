...
# Mapping des slugs Sportity (ex: "WRCSWE26") vers les clés courtes du calendrier.
# Permet au polling automatique de retrouver l'URL Sportity sauvegardée via /wrc_scan.
_SPORTITY_KEY_MAP = {
    "WRCMC26":  "MC",
    "WRCSWE26": "SWE",
    "WRCKEN26": "KEN",
...
class WRCCalendar:
    ...
    def sportity_key_to_rally_key(self, sportity_key: str) -> Optional[str]:
        """Convertit un slug Sportity (ex: 'WRCSWE26') en clé courte (ex: 'SWE')."""
        return _SPORTITY_KEY_MAP.get(sportity_key.upper())
