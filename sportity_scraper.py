...
class SportityScraper:
    ...
    def _encode_url(url: str) -> str:
        """Encode spaces and unsafe chars in the path while preserving the scheme/host."""
        # Only encode the path portion — scheme, host and query stay intact
        # e.g. "https://cdn.../abc_Bulletin 1.pdf" → "https://cdn.../abc_Bulletin%201.pdf"
